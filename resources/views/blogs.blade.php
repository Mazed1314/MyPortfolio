...
@include('layout.header')
        ...
        <!-- start hero -->
        <section class="hero-one position-relative bg-black" id="about"  style="background-image: url{{asset('public/asset/images/personal/main-bg.png')}}; background-size: cover; background-position: center center;">
            <div class="container">
        ...
        <section class="section">
            <div class="container">     
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="card shadow  mb-4">
                            <img src="{{asset('public/asset/images/personal/4.jpg')}}" alt="" class="img-fluid rounded-top">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card shadow  mb-4">
                            <img src="{{asset('public/asset/images/personal/5.jpg')}}" alt="" class="img-fluid rounded-top">
                            <div class="card-body">                                
                                <a href="blog-detail.html" class="fs-20 my-0 d-block fw-medium">With a clean, minimal and professional look</a>
                                <hr class="hr-dashed">
                                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card shadow  mb-4">
                            <img src="{{asset('public/asset/images/personal/6.jpg')}}" alt="" class="img-fluid rounded-top">
                            <div class="card-body">                                
                                <a href="blog-detail.html" class="fs-20 my-0 d-block fw-medium">With a clean, minimal and professional look</a>
                                <hr class="hr-dashed">
                                <div class="d-flex justify-content-between">
